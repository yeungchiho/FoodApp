                    ...
                    <div class="table-box">
                        ...
                        <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                            ...
                            <c:forEach items="${orderedList}" var="orderPublished" varStatus="vs">
                                <tr>
                                    <td>${orderPublished.order_id}</td>
                                    <td>${orderPublished.order_receiver}</td>
                                    <td>${orderPublished.order_phone}</td>
                                    <td>${orderPublished.order_num}</td>
                                    <td>${orderPublished.order_product}</td>
